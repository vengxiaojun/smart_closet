...
typedef struct {
    ...
    void (*on_response_output_item_done)(aigw_ws_response_output_item_t *output_item, void *user_data);
    void (*on_transcript_done)(const void *transcript_data, size_t transcript_len, void *user_data);     // 用户说的话转录文本流式回调（目标语种）
